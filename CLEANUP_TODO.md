...
- [ ] `crates/noti-providers/src/twilio.rs:137-142` — MMS attachment fallback path unconditionally constructs `data:` URI when media upload fails; should log a warning and skip the attachment instead of sending potentially invalid data URI
